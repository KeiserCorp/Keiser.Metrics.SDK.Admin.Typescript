## @keiser/metrics-sdk-admin-typescript@5.3.11
...
```
npm install @keiser/metrics-sdk-admin-typescript@5.3.11 --save
```
...
## Documentation for Models
 ...
 - [AccessControlRight](docs/AccessControlRight.md)
 - [AnalyticRight](docs/AnalyticRight.md)
 ...
 - [High](docs/High.md)
 - [LicenseRight](docs/LicenseRight.md)
 - [Low](docs/Low.md)
